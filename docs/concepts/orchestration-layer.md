...
- retrieval, which grounds answers in approved sources and can cite them so a reviewer can check each answer, shown by the [curriculum advisor](../getting-started/curriculum-advisor.md)'s RAG on Dify;
